...
function _moduleContent(&$smarty, $module_name)
{
    ...
    $paramFiltroBase = $paramFiltro = array(
        'txt_fecha_init'    => date("d M Y 00:00"),
        'txt_fecha_end'     => date("d M Y 23:59"),
    );
    ...
    $paramFiltro['txt_fecha_init'] = date('Y-m-d H:i:s',strtotime($paramFiltro['txt_fecha_init'].":00"));
    $paramFiltro['txt_fecha_end']   = date('Y-m-d H:i:s',strtotime($paramFiltro['txt_fecha_end'].":59"));
