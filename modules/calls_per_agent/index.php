...
function _moduleContent(&$smarty, $module_name)
{
    ...
    $date_start_format = date('Y-m-d H:i:s',strtotime($arrFilterExtraVars['date_start'].":00"));
    $date_end_format   = date('Y-m-d H:i:s',strtotime($arrFilterExtraVars['date_end'].":59"));
